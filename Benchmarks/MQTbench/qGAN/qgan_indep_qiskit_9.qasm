...
qreg q[9];
creg meas[9];
u3(2.1457371,0,-pi) q[0];
u3(1.8286854,-pi,0) q[1];
cz q[0],q[1];
u3(2.5155682,0,-pi) q[2];
cz q[0],q[2];
cz q[1],q[2];
u3(1.7105514,-pi,0) q[3];
cz q[0],q[3];
cz q[1],q[3];
cz q[2],q[3];
u3(1.8512779,0,-pi) q[4];
cz q[0],q[4];
cz q[1],q[4];
cz q[2],q[4];
cz q[3],q[4];
u3(1.8863974,0,-pi) q[5];
cz q[0],q[5];
cz q[1],q[5];
cz q[2],q[5];
cz q[3],q[5];
cz q[4],q[5];
u3(2.1346591,0,-pi) q[6];
cz q[0],q[6];
cz q[1],q[6];
cz q[2],q[6];
cz q[3],q[6];
